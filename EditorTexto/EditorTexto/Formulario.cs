...
namespace EditorTexto
{
    public partial class frmEditor : Form
    {
        ...
        public List<string> historialTexto = new List<string>();
        public List<Font> HistorialFuentes = new List<Font>();
        ...
        {
            txtTexto.Enabled = buscarArchivo();
        }
        ...
        {
            if (txtBuscar.Text == "" || txtReemplazo.Text == "" || txtBuscar.Text == null || txtReemplazo.Text == null)
            {
                return false;
            }
        ...
        private bool buscarArchivo()
        {
            archivo.Filter = "Texto Text|*.txt";
            archivo.Title = "Abrir archivo";
            archivo.ShowDialog();
            return abrirArchivo(archivo.FileName);
        }
        ...
        public bool guardarArchivo()
        {
            try
            {
                if (txtTexto.Enabled == true)
                {
                    File.WriteAllText(ruta, txtTexto.Text);
                ...
                {
                    //System.Windows.Forms.MessageBox.Show("No hay qué guardar  :)");
                    return false;
                }
            ...
            {
                MessageBox.Show("Error al guardar archivo. Error: " + ex.ToString());
                return false;
            }
